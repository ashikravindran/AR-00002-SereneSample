...
namespace AR_00002_SereneSample.BasicSamples.Endpoints
{
    using Serenity;
    using Serenity.Data;
    ...
    public class VSGalleryQAController : ServiceEndpoint
    {
        ...
        private List<VSGalleryQAThread> LoadFromLocalCopy()
        {
            ...
            if (!System.IO.File.Exists(path))
            {
                ...
                var bytes = new WebClient().DownloadData("https://github.com/volkanceylan/AR_00002_SereneSample/raw/master/AR_00002_SereneSample/AR_00002_SereneSample.Web/" + 
